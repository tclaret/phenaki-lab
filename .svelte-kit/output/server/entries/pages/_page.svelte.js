...
function AnalyzerPanel($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    if (store_get($$store_subs ??= {}, "$flickerEnabled", flickerEnabled)) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<div style="margin-top: 16px; padding: 12px; background: rgba(74, 158, 255, 0.08); border-radius: 6px; border: 1px solid rgba(74, 158, 255, 0.2);" class="svelte-14nyow8"><div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 10px;" class="svelte-14nyow8"><div style="font-weight: 600; color: #4a9eff; font-size: 0.95em;" class="svelte-14nyow8">⚡ Flicker Fusion Threshold</div> <a href="https://en.wikipedia.org/wiki/Flicker_fusion_threshold" target="_blank" rel="noopener noreferrer" style="display: flex; align-items: center; gap: 4px; font-size: 0.75em; color: #aaa; text-decoration: none; opacity: 0.7; transition: opacity 0.2s;" title="Learn more on Wikipedia" class="svelte-14nyow8"><svg width="14" height="14" viewBox="0 0 240 240" xmlns="http://www.w3.org/2000/svg" class="svelte-14nyow8"><path fill="currentColor" d="M120 0C53.8 0 0 53.8 0 120s53.8 120 120 120 120-53.8 120-120S186.2 0 120 0zm0 217.5c-53.8 0-97.5-43.7-97.5-97.5S66.2 22.5 120 22.5s97.5 43.7 97.5 97.5-43.7 97.5-97.5 97.5zm-7.5-165h15v90h-15zm0 105h15v15h-15z" class="svelte-14nyow8"></path></svg> <span class="svelte-14nyow8">Wikipedia</span></a></div> <div style="font-size: 0.8em; color: #888; font-style: italic; margin-bottom: 10px;" class="svelte-14nyow8">Note: This test only affects visualization, not the exported GIF</div> <div style="margin-bottom: 12px;" class="svelte-14nyow8"><div style="font-size: 0.85em; color: #aaa; margin-bottom: 6px;" class="svelte-14nyow8">Quick Presets:</div> <div style="display: flex; gap: 6px; flex-wrap: wrap;" class="svelte-14nyow8"><button class="flicker-preset-btn svelte-14nyow8"${attr_style(`border: 1px solid ${stringify(store_get($$store_subs ??= {}, "$flickerFrequency", flickerFrequency) === 30 ? "#c92a2a" : "#555")}; background: ${stringify(store_get($$store_subs ??= {}, "$flickerFrequency", flickerFrequency) === 30 ? "#c92a2a" : "#333")}; color: white; border-radius: 6px; cursor: pointer;`)}>30 Hz</button> <button class="flicker-preset-btn svelte-14nyow8"${attr_style(`border: 1px solid ${stringify(store_get($$store_subs ??= {}, "$flickerFrequency", flickerFrequency) === 42 ? "#ff6b6b" : "#555")}; background: ${stringify(store_get($$store_subs ??= {}, "$flickerFrequency", flickerFrequency) === 42 ? "#ff6b6b" : "#333")}; color: white; border-radius: 6px; cursor: pointer;`)}>42 Hz</button> <button class="flicker-preset-btn svelte-14nyow8"${attr_style(`border: 1px solid ${stringify(store_get($$store_subs ??= {}, "$flickerFrequency", flickerFrequency) === 50 ? "#ffa500" : "#555")}; background: ${stringify(store_get($$store_subs ??= {}, "$flickerFrequency", flickerFrequency) === 50 ? "#ffa500" : "#333")}; color: white; border-radius: 6px; cursor: pointer;`)}>50 Hz</button> <button class="flicker-preset-btn svelte-14nyow8"${attr_style(`border: 1px solid ${stringify(store_get($$store_subs ??= {}, "$flickerFrequency", flickerFrequency) === 55 ? "#4a9eff" : "#555")}; background: ${stringify(store_get($$store_subs ??= {}, "$flickerFrequency", flickerFrequency) === 55 ? "#4a9eff" : "#333")}; color: white; border-radius: 6px; cursor: pointer;`)}>55 Hz</button> <button class="flicker-preset-btn svelte-14nyow8"${attr_style(`border: 1px solid ${stringify(store_get($$store_subs ??= {}, "$flickerFrequency", flickerFrequency) === 60 ? "#51cf66" : "#555")}; background: ${stringify(store_get($$store_subs ??= {}, "$flickerFrequency", flickerFrequency) === 60 ? "#51cf66" : "#333")}; color: white; border-radius: 6px; cursor: pointer;`)}>60 Hz</button> <button class="flicker-preset-btn svelte-14nyow8"${attr_style(`border: 1px solid ${stringify(store_get($$store_subs ??= {}, "$flickerFrequency", flickerFrequency) === 70 ? "#845ef7" : "#555")}; background: ${stringify(store_get($$store_subs ??= {}, "$flickerFrequency", flickerFrequency) === 70 ? "#845ef7" : "#333")}; color: white; border-radius: 6px; cursor: pointer;`)}>70 Hz</button> <button class="flicker-preset-btn svelte-14nyow8"${attr_style(`border: 1px solid ${stringify(store_get($$store_subs ??= {}, "$flickerFrequency", flickerFrequency) === 80 ? "#20c997" : "#555")}; background: ${stringify(store_get($$store_subs ??= {}, "$flickerFrequency", flickerFrequency) === 80 ? "#20c997" : "#333")}; color: white; border-radius: 6px; cursor: pointer;`)}>80 Hz</button> <button class="flicker-preset-btn svelte-14nyow8"${attr_style(`border: 1px solid ${stringify(store_get($$store_subs ??= {}, "$flickerFrequency", flickerFrequency) === 100 ? "#12b886" : "#555")}; background: ${stringify(store_get($$store_subs ??= {}, "$flickerFrequency", flickerFrequency) === 100 ? "#12b886" : "#333")}; color: white; border-radius: 6px; cursor: pointer;`)}>100 Hz</button></div></div> <div style="margin-top: 12px;" class="svelte-14nyow8"><div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 6px;" class="svelte-14nyow8"><span style="font-size: 0.85em; color: #ccc;" class="svelte-14nyow8">Fine Tune:</span> <span style="font-size: 1.1em; font-weight: bold; color: #4a9eff;" class="svelte-14nyow8">${escape_html(store_get($$store_subs ??= {}, "$flickerFrequency", flickerFrequency))} Hz</span></div> <input type="range" min="20" max="100" step="0.5"${attr("value", store_get($$store_subs ??= {}, "$flickerFrequency", flickerFrequency))} style="width: 100%; cursor: pointer;" class="svelte-14nyow8"/> <div style="display: flex; justify-content: space-between; font-size: 0.7em; color: #666; margin-top: 4px;" class="svelte-14nyow8"><span class="svelte-14nyow8">20 Hz</span> <span style="color: #4a9eff; font-weight: 500;" class="svelte-14nyow8">`);
      if (store_get($$store_subs ??= {}, "$flickerFrequency", flickerFrequency) < 40) {
        $$renderer2.push("<!--[-->");
        $$renderer2.push(`🔴 Flicker`);
      } else {
        $$renderer2.push("<!--[!-->");
        if (store_get($$store_subs ??= {}, "$flickerFrequency", flickerFrequency) < 60) {
          $$renderer2.push("<!--[-->");
      ...
      $$renderer2.push(`<!--]--></span> <span class="svelte-14nyow8">100 Hz</span></div></div> <div style="margin-top: 10px; padding: 8px; background: rgba(74, 158, 255, 0.12); border-radius: 4px; font-size: 0.8em;" class="svelte-14nyow8"><div style="font-weight: 500; color: #4a9eff; margin-bottom: 3px;" class="svelte-14nyow8">`);
    ...
    if (store_get($$store_subs ??= {}, "$detectedCircle", detectedCircle)) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<div${attr_class(`speed-control ${stringify("")} ${stringify("")} ${stringify(store_get($$store_subs ??= {}, "$isMobile", isMobile) ? "mobile" : "")}`, "svelte-14nyow8")}${attr_style(store_get($$store_subs ??= {}, "$isMobile", isMobile) ? `top: ${Math.round((window.innerHeight - 80) / 2)}px;` : `left: ${Math.round((window.innerWidth - 200) / 2)}px; top: ${Math.round((window.innerHeight - 80) / 2)}px;`)}>`);
      if (store_get($$store_subs ??= {}, "$isMobile", isMobile)) {
        $$renderer2.push("<!--[-->");
